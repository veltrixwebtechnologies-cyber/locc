...
export const BEST_SHOPS: ShopMetrics[] = [
  {
    shopId: "s_kovil_bakes",
    shopName: "Roja Bakes & Sweets (கோவில்மேடு)",
    rating: 4.9,
    totalOrders: 2800,
    ...
    popularProduct: "Mysurpa & Hot Puffs",
  },
  {
    shopId: "s_kovil_pala",
    shopName: "Kovilmedu Organic Palamuthir Nilayam",
    rating: 4.9,
    totalOrders: 2100,
    repeatCustomerRate: 86,
    avgDeliveryMins: 18,
    ...
    popularProduct: "Organic Tender Coconut",
  },
  {
    shopId: "s_kovil_pharm",
    shopName: "Kovilmedu Care Medicals",
    rating: 4.8,
    totalOrders: 3500,
  ...
  {
    shopId: "s_kovil_jewel",
    shopName: "Meenakshi Jewellery & Gift Corner",
    rating: 4.9,
    totalOrders: 1100,
    ...
    popularProduct: "Gold-plated Kammal",
  },
  {
    shopId: "s_kovil_flour",
    shopName: "Sri Amman Flour & Masala Mill",
    rating: 4.9,
    totalOrders: 1900,
