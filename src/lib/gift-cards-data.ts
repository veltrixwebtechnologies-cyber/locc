...
export const GIFT_CARD_TYPES: GiftCardType[] = [
  {
    id: "localshore",
    name: "LocalShore Gift Card",
    description: "Use across all eligible LocalShore purchases",
    icon: "🏪",
  },
  {
    id: "brand",
    name: "Brand Gift Cards",
    description: "Purchase gift cards from participating brands",
    icon: "🏷️",
  },
  {
    id: "shop",
    name: "Local Shop Gift Cards",
    description: "Gift cards for specific partner shops",
    icon: "🛒",
  },
];
...
export const SAMPLE_GIFT_CARDS: GiftCardInstance[] = [
  {
    ...
    status: "active",
    senderName: "Priya",
    message: "Happy birthday! Shop local 🎉",
    designId: "birthday",
