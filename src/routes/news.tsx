...
function NewsPage() {
  ...
  const categories: ("all" | NewsArticle["category"])[] = [
    "all",
    "launch",
    "seller_story",
    "brand",
      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 pb-12">
        ...
        >
          ...
          <p className="mt-2 max-w-lg text-sm text-slate-300">
            Stay updated with the latest from LocalShore — launches, seller stories, guides, and
          ...
          >
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex flex-col justify-center p-5 sm:p-6">
                <span
                  className={`inline-block w-fit rounded-full px-2.5 py-0.5 text-[10px] font-bold ${catColor[featured.category]}`}
                >
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {rest.map((article, i) => (
            ...
            >
              ...
              <div className="p-4">
                <span
                  className={`inline-block rounded-full px-2 py-0.5 text-[10px] font-bold ${catColor[article.category]}`}
                >
                ...
                <div className="mt-3 flex items-center gap-3 text-[11px] text-slate-400">
                  ...
                  <span className="flex items-center gap-0.5">
                    <BookOpen className="h-3 w-3" /> {article.readingTime} min
                  </span>
                  <span>
