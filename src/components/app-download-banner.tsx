...
export const AppDownloadBanner: React.FC = () => {
  ...
  return (
    <div className="mx-5 my-8 md:mx-8">
      <div className="relative overflow-hidden rounded-[1.75rem] bg-[#070a16] border border-[#1d2642] shadow-2xl">
        {/* Subtle Ambient Background Gradient */}
        <div 
          className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#182348]/40 via-[#0a0e21] to-[#060813] opacity-90"
        />

        {/* Ambient Glow Effects */}
        <div className="absolute -top-20 -left-20 h-64 w-64 rounded-full bg-amber-500/10 blur-3xl" />
        <div className="absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-indigo-600/15 blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 p-6 sm:p-8 lg:p-9">
          ...
          <div className="flex-1 space-y-4 text-left">
            <div className="flex items-center space-x-2.5">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[#2a2208]/90 px-3 py-1 text-xs font-bold text-[#facc15] border border-[#52410a]">
                <Sparkles className="h-3.5 w-3.5 text-[#facc15] animate-pulse" />
                {config.badge1_text}
              </span>
              <Badge variant="outline" className="border-[#0a4d38] text-[#2dd4bf] bg-[#06241a]/80 font-bold px-3 py-1">
                {config.badge2_text}
              </Badge>
            </div>
            ...
            <form onSubmit={handleSendLink} className="pt-2 flex flex-col sm:flex-row gap-2.5 max-w-md">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-[#0e1428] border border-[#232c48] py-2.5 pl-12 pr-4 text-xs text-white placeholder-slate-500 outline-none focus:border-[#facc15] focus:ring-1 focus:ring-[#facc15] transition-all font-mono shadow-inner"
                />
              </div>
              <button
                type="submit"
          ...
          <div className="w-full lg:w-auto shrink-0">
            <div className="relative rounded-2xl bg-[#11162b]/80 border border-[#232c4a] backdrop-blur-md p-5 sm:p-6 shadow-2xl flex flex-col sm:flex-row items-center gap-5">
              ...
              <div className="flex flex-col gap-3 w-full sm:w-60">
                ...
                <a
                  ...
                  className="group flex items-center justify-between gap-3 rounded-xl bg-[#0a0e1c] hover:bg-[#0f152a] border border-[#1f2845] hover:border-[#35436e] p-2.5 transition-all shadow-md active:scale-98"
                >
                  ...
                  <div className="text-right border-l border-[#1f2845] pl-2.5 shrink-0">
              ...
              <div className="flex flex-col items-center justify-center p-2.5 rounded-xl bg-white text-slate-950 shadow-xl border border-white/20 shrink-0">
                <div className="relative p-1 rounded-lg bg-slate-50 border border-slate-200">
                  <svg className="w-24 h-24" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* Center LocalShore Accent Dot */}
                    <circle cx="50" cy="50" r="7" fill="#b91c1c" />
                  </svg>
                </div>
                <div className="mt-1 flex items-center gap-1 text-[9px] font-black text-slate-800 uppercase tracking-wider">
